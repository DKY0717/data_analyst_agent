...
| 第4章 Schema 加载 | `backend/app/db/connection.py`、`backend/app/db/schema_loader.py`、`backend/app/utils/schema_formatter.py`、`backend/alembic/` | `backend/tests/test_schema_loader.py`、`backend/tests/test_migrations.py` | `pytest backend/tests/test_schema_loader.py backend/tests/test_migrations.py -q` |
...
| 第15章 Vue 工作台 | `frontend/src/views/Home.vue`、`frontend/src/stores/query.js`、`frontend/src/components/`、`frontend/src/utils/spreadsheet.js` | `frontend/tests/`、`frontend/tests/utils/spreadsheet.test.js` | `npm run test --prefix frontend` |
| 第16章 自动化测试 | `backend/tests/`、`backend/requirements-dev.txt`、`pyproject.toml`、`frontend/tests/`、`frontend/eslint.config.js`、`frontend/e2e/` | pytest、覆盖率、Ruff、Vitest、ESLint、Playwright 测试套件 | `pytest backend/tests/test_core_path_cases.py backend/tests/test_migrations.py -q` |
| 第17章 评测体系 | `backend/evaluation/`、`backend/evaluation/cases/`、`backend/evaluation/core_path_runner.py`、`backend/evaluation/quality_gate.py` | `backend/tests/test_evaluator.py`、`backend/tests/test_quality_gate.py`、核心路径报告 | `pytest backend/tests/test_evaluator.py backend/tests/test_quality_gate.py -q` |
| 第18章 Docker 与 CI | `backend/Dockerfile`、`frontend/Dockerfile`、`frontend/nginx.conf`、`docker-compose.yml`、`docker-compose.secure.yml`、`backend/alembic/`、`.github/workflows/` | `backend/tests/test_workflow_files.py`、`backend/tests/test_migrations.py` | `pytest backend/tests/test_workflow_files.py backend/tests/test_migrations.py -q` |
| 第19章 完整复现 | `README.md`、`scripts/interview_demo_preflight.py`、`backend/evaluation/core_path_runner.py`、`backend/evaluation/cases/core_path_cases.yaml` | `backend/tests/test_interview_demo_preflight_script.py`、`backend/tests/test_core_path_cases.py`、核心路径执行报告 | `cd backend; python -m evaluation.core_path_runner` |
